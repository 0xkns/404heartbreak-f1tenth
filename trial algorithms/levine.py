...
def decide_obstacle_direction(data, start_point, end_point):
    ...
    if start_point != -1 or end_point != -1:
        ...
        print
        "Right Width", start_pointdistance
        print
        "left Width", end_pointdistance
        car_dist_right = getRange(data, 0) * math.cos(alpha)
        car_dist_left = getRange(data, 179) * math.cos(alpha)

        print
        "Car dist right", car_dist_right
        print
        "Car dist left", car_dist_left
        ...
        print
        "Right edge", obstacle_distance_right
        print
        "left edge", obstacle_distance_left
    ...
    print
    "Desired dist", desired_trajectory
...
def followRight(data, desired_trajectory):
    ...
    "a", "b", a, b
    print
    "Alpha right", math.degrees(alpha)
